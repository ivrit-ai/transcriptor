...
class Page(Base):
    ...
    raw_image_path: Mapped[str | None] = mapped_column(String, nullable=True, default=None)
    raw_width_px: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    raw_height_px: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
